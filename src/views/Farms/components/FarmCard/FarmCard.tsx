...
const FarmCard: React.FC<FarmCardProps> = ({ farm, removed, lydPrice, account, wavaxPrice }) => {
  ...
  return (
    <FCard>
      {(farm.token.symbol === 'MORPH' || farm.quoteToken.symbol === 'MORPH' || farm.token.symbol === 'CAKE' || farm.quoteToken.symbol === 'CAKE' || farm.token.symbol === 'KINS' || farm.token.symbol === 'PAPR') && <StyledCardAccent />}
      <CardHeading
        lpLabel={lpLabel}
