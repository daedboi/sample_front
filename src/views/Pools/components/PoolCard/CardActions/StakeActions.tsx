...
import { Flex, Text, Button, IconButton, AddIcon, MinusIcon, Heading, useModal, Skeleton } from 'trinityhelper'
      ...
      <Flex justifyContent="space-between" alignItems="center">
        ...
        <Flex>
          <IconButton variant="secondary" onClick={onPresentUnstake} mr="6px">
            <MinusIcon color="secondary" width="24px" />
          </IconButton>
          <IconButton
            variant="secondary"
            ...
            disabled={isFinished}
          >
            <AddIcon color="secondary" width="24px" height="24px" />
          </IconButton>
        </Flex>
      </Flex>
    ) : (
