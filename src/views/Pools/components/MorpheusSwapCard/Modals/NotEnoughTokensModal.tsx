...
import { Modal, Text, Button, OpenNewIcon, Link } from 'trinityhelper'
...
const NotEnoughTokensModal: React.FC<NotEnoughTokensModalProps> = ({ tokenSymbol, onDismiss }) => {
  ...
  return (
    ...
    >
      ...
      <Text mt="24px">{t(`You’ll need %tokensymbol% to swap in this pool!`, { tokensymbol: tokenSymbol })}</Text>
      <Text>
      ...
      <StyledLink href="https://spookyswap.finance/swap" external>
