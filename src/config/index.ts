...
export const BASE_EXCHANGE_URL = 'https://swap.morpheusswap.app/'
export const BASE_ADD_LIQUIDITY_URL = BASE_EXCHANGE_URL
export const BASE_TOKEN_LIQUIDITY_URL = BASE_EXCHANGE_URL
export const BASE_LIQUIDITY_POOL_URL = BASE_EXCHANGE_URL
