...
$packages["main"] = (function() {
	...
	main = function() {
		...
		$global.addEventListener($externalize("load", $String), $externalize((function $b() {
			...
			rain1 = [rain1];
			rain2 = [rain2];
			lowGlyphCanvases = new sliceType([NewGlyphCanvas("#6bb86b"), NewGlyphCanvas("#3b803b")]);
			highGlyphCanvases = new sliceType([NewGlyphCanvas("#5ba860"), NewGlyphCanvas("#5b9b60")]);
			backgrounds = new sliceType$1(["#dcfee2", "#000000"]);
			...
			cover.style[$externalize("background-image", $String)] = $externalize("radial-gradient(ellipse farthest-corner at 45px 45px , #00ff42 0%, rgba(0, 0, 255, 0) 50%, #0cff00 95%)", $String);
	...
	NewGlyphCanvas = function(color) {
		...
		col = 0;
		row = 1;
		_ref = "01011011000110011110010101001110010000110100100010111011100101";
		_i = 0;
		while (true) {
			if (!(_i < _ref.length)) { break; }
